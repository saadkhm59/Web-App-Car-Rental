...
<head>
    ...
    <title>Véhicules en location</title>
    <style>
        body {
...
<body>
    ...
    $rentedVehiclesStmt = $pdo->query('
        SELECT id, brand, model, year, price_per_day, registration_number
        FROM cars
        WHERE status = "En location"
    ');

    $rentedVehicles = $rentedVehiclesStmt->fetchAll();
    ?>
    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($rentedVehicles as $vehicle): ?>
                    <tr>
